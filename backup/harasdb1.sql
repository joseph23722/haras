...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_equino_editar` (IN `_idEquino` INT, IN `_idPropietario` INT, IN `_pesokg` DECIMAL(5,1), IN `_idEstadoMonta` VARCHAR(50), IN `_estado` ENUM('Vivo','Muerto'))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_historial_medico_registrarMedi` (IN `_idEquino` INT, IN `_idUsuario` INT, IN `_idMedicamento` INT, IN `_dosis` VARCHAR(50), IN `_frecuenciaAdministracion` VARCHAR(50), IN `_idViaAdministracion` INT, IN `_fechaFin` DATE, IN `_observaciones` TEXT, IN `_reaccionesAdversas` TEXT, IN `_tipoTratamiento` VARCHAR(20))   BEGIN
...
(10, 3, 'diagnosticar-equino', 'N', NULL, NULL),
(11, 3, 'listar-diagnostico-avanzado', 'N', NULL, NULL),
(12, 3, 'revisar-equino', 'N', NULL, NULL),
(13, 3, 'seleccionar-diagnostico', 'S', 'Diagnóstico', 'fa-solid fa-notes-medical'),
(14, 4, 'administrar-alimento', 'S', 'Alimentos', 'fas fa-apple-alt'),
(15, 4, 'administrar-herramienta', 'S', 'Herrero', 'fas fa-wrench'),
(16, 4, 'administrar-medicamento', 'S', 'Medicamentos', 'fas fa-pills'),
(17, 4, 'listar-accion-herrero', 'N', NULL, NULL),
(18, 4, 'listar-alimento', 'N', NULL, NULL),
(19, 4, 'listar-implemento-caballo', 'N', NULL, NULL),
(20, 4, 'listar-implemento-campo', 'N', NULL, NULL),
(21, 4, 'listar-medicamento', 'N', NULL, NULL),
(22, 4, 'registrar-implemento-caballo', 'S', 'Implementos Caballos', 'fa-solid fa-scissors'),
(23, 4, 'registrar-implemento-campo', 'S', 'Implementos Campos', 'fa-solid fa-wrench'),
(24, 5, 'presionar-boton-reporte', 'S', 'Reportes', 'fa-solid fa-file-circle-plus'),
(25, 6, 'listar-medicamento-usado', 'N', NULL, NULL),
(26, 6, 'listar-servicio', 'S', 'Listado Servicios', 'fa-solid fa-list'),
