...
<main>
  <div class="container-fluid px-4">
    ...
    <h1 class="mt-4 text-center text-uppercase" style="font-weight: bold; font-size: 36px; color: #001F3F; letter-spacing: 2px;">
      <i class="fas fa-key" style="color: #001F3F; font-size: 38px;"></i> Actualizar Contraseña
    </h1>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <form id="formActualizarContrasenia" class="shadow-lg p-5 rounded-4 bg-white border border-light">
          <div class="mb-4">
            <label for="correo" class="form-label fs-5 text-muted"><i class="fas fa-user-circle" style="color: #123524;"></i> Correo o Nombre de Usuario</label>
          ...
          <div class="mb-4">
            <label for="clave" class="form-label fs-5" style="color: #000;"><i class="fas fa-lock" style="color: #123524;"></i> Nueva Contraseña</label>
          ...
          <div class="mb-4">
            <label for="confirmarContrasenia" class="form-label fs-5" style="color: #000;"><i class="fas fa-lock" style="color: #123524;"></i> Confirmar Contraseña</label>
          ...
          <div class="d-flex justify-content-between">
            <button type="button" class="btn btn-danger btn-lg px-4 rounded-pill shadow" data-bs-dismiss="modal"
              style="background-color: #521212; border-color: #521212; color: #EFE3C2;">
              <i class="fas fa-times-circle"></i> Cancelar
            </button>
            <button type="submit" class="btn btn-success btn-lg px-4 rounded-pill shadow" id="btnActualizarContrasenia"
              style="background-color: #123524; border-color: #123524; color: #EFE3C2;">
