...
<main>
  <div class="container-fluid px-4">
    <h1 class="mt-4 text-center text-uppercase" style="font-weight: bold; font-size: 36px; color: #000;">
      <i class="fas fa-users" style="color: #000;"></i> Registrar Personal y Listado de Usuarios
    </h1>
        ...
        <form action="" autocomplete="off" id="formulario-personal">
          <div class="card shadow border-0">
              ...
              <div class="row g-3 mb-3">
                <div class="col-md-2">
                  <div class="form-floating">
                    ...
                    <label for="dni"><i class="fas fa-id-badge" style="color: #001F3F;"></i> Nro. Documento</label>
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="apellidos" maxlength="100" required>
                    <label for="apellidos"><i class="fas fa-user" style="color: #001F3F;"></i> Apellidos Completos</label>
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="nombres" maxlength="100" required>
                    <label for="nombres"><i class="fas fa-user-tag" style="color: #001F3F;"></i> Nombres Completos</label>
                  </div>
                </div>
              </div>
              <!-- Fin Fila 1 -->
              ...
              <div class="row g-3 mb-3">
                <div class="col-md-3">
                  <div class="form-floating">
                    ...
                    <label for="tipodoc"><i class="fas fa-passport" style="color: #001F3F;"></i> Tipo de documento</label>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="direccion" maxlength="255">
                    <label for="direccion"><i class="fas fa-map-marker-alt" style="color: #001F3F;"></i> Dirección</label>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-floating">
                    <input type="date" class="form-control" id="fechaIngreso">
                    <label for="fechaIngreso"><i class="fas fa-calendar-check" style="color: #001F3F;"></i> Fecha de Ingreso</label>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-floating">
                    ...
                    <label for="tipoContrato"><i class="fas fa-briefcase" style="color: #001F3F;"></i> Tipo de contrato</label>
                  </div>
                </div>
              </div>
              <!-- Fin Fila 2 -->
            ...
            <div class="card-footer text-end">
              <button type="submit" class="btn btn-lg shadow-sm me-2" style="background-color: #123524; color: #EFE3C2">
                <i class="fas fa-save"></i> Registrar
              </button>
              <button type="reset" class="btn btn-lg shadow-sm" style="background-color: #adb5bd;">
        ...
        <div class="card shadow border-0">
          <div class="card-header" style="background: linear-gradient(to left, #123524, #356C56); color: #EFE3C2;">
            <h5 class="text-center m-0" style="font-weight: bold;">
              <i class="fas fa-users" style="color: #EFE3C2;"></i> Datos de los Usuarios
            </h5>
          </div>
          <div class="card-body p-4" style="background-color: #f9f9f9;">
            <table id="tabla-personal" class="table table-striped table-hover table-bordered">
              <thead style="background-color: #001F3F; color: #003366;">
                <tr>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-hashtag"></i></th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-id-card"></i> Tipo Documento</th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-address-card"></i> Nro. Documento</th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-user"></i> Apellidos</th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-user"></i> Nombres</th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-map-marker-alt"></i> Dirección</th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-user-circle"></i> Cuenta Usuario</th>
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-envelope"></i> Usuario</th> <!-- Columna de correo -->
                  <th style="background-color: #001F3F; color: #EFE3C2"><i class="fas fa-sync-alt"></i> Estado</th>
